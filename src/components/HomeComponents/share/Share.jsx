        ...
        <ShareBottom>
          <ShareOptions>
            <ShareOption>
              ...
              {pdfFileName && <FileNameDisplay>{pdfFileName}</FileNameDisplay>}
            </ShareOption>
            <ShareOption>
              <input
                accept="audio/*"
              ...
              {audioFileName && <FileNameDisplay>{audioFileName}</FileNameDisplay>}
            </ShareOption>
            <ShareOption>
              <Button
                  variant="contained"
          ...
          <ShareButton onClick={handleShare} disabled={!description.trim() || (!audioFile && !pdfFile)} sx={{color: '#6d4c41'}}>
            Share
          </ShareButton>
        </ShareBottom>
        {errorMessage && (
